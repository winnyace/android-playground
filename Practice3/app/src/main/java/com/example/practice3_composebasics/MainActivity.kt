...
import com.example.practice3_composebasics.ui.theme.Practice3ComposeBasicsTheme
...
fun Screen() {
    ...
    Column(Modifier.fillMaxWidth().padding(systemBars.asPaddingValues())) {
